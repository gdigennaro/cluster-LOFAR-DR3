...
- check_cluster_inLoTSSfields.py associates all the clusters in a given sample to the LoTSS-DR3 pointing. CLUSTERCATALOG.fits becomes CLUSTERCATALOGmatched.fits
